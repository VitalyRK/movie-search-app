...
const nextConfig = {
  ...
  async rewrites() {
    return [
      ...
      {
        source: '/movies/:fiters',
        destination: `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&include_adult=false&include_video=false&language=en-US&:fiters/`,
      },
      {
        source: '/details/:id/',
